...
Network profile: Attaches the NIC created above and it acts like a firewall. 
This NSG:
Allows inbound TCP traffic on port 3389 (RDP)
Blocks all else by default

After deployment, Azure will return the public IP address of the VM which will be used as RDP IP.
